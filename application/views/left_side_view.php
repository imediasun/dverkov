<div class="row-fluid">
		...
		<form id="filter_form" action="/catalog/index" method="post">
		<? if(isset($type)){
		?>
		...
		?>
		<input type="hidden" id="rtv" name="type" value="<?echo $filter_type?>"/>
		<?
		}
...
switch(krey){
case '1':
$('#mezhkomnatnie_btn').find('h3').css('color','#fff')
...
break;
case '2':
$('#vhodnie_btn').find('h3').css('color','#fff')
