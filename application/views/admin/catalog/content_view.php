catalog
	<div class="span10a" style="width:100%">
		...
		<div id="progress_bar">
			...
			<div class="icon_text_div"><h3 class="icon_text">Добавить модель</h3></div>
...
location.href = '/admin/add_door/<?=$type_page;?>/<?=$producer;?>'
})
$('#add_model').click(function(){
location.href = '/admin/add_model/<?=$type_page;?>/<?=$producer;?>'
})
$('#add_collection').click(function(){
location.href = '/admin/add_collection/<?=$type_page;?>/<?=$producer;?>'
})
</script>	