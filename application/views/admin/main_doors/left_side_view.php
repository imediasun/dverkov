...
var msg = $(this).serialize();
		...
		type: "POST",
		dataType: 'json',
		url: "/admin/main_page_filter",
		data: {msg},
		success: function (data) {
		$('.item_doors_slider').empty();
$('.item_doors_slider').append('<div class="doors-items door_slider doors_slider">')
$.each(data, function(i, item) {
$('.doors-items').append('<div class="y"><div class="item_door_slide door_point"><img class="door_img" src="'+item.photo+'"><input type="checkbox" name="check_add" value="'+item.id+'"></div></div>');
});
...
$.ajax({
			...
			window.location.href ='http://dverkov.com.ua/admin/pages/4/'+ar+'';
