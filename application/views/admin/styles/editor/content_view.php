<script type="text/javascript" src="/js/jquery.damnuploader.js"></script>
	...
	<div style="" class="row row_style">
		<div class="span2">
			...
			<img height="200px" src="<?=$style[0]['image']?>">
			</p>
			<?}?>
		</div>
		<div style="border-left:1px solid #000;padding:10px;" class="span4">
			...
			<input name="name" style="height:30px;width:80%" type="text" value="<?=$style[0]['name']?>">
			<input name="id" type="hidden" value="<?=$style[0]['id']?>">
			<input name="type" type="hidden" value="<?=$type_page?>">
			<input name="proc" type="hidden" value="styles">
			<br>
