стили
	<div class="span10a">
	<div id="progress_bar">
		<div class="icon_text_div"><h3 class="icon_text">Добавить стиль</h3></div>
		<a href="/admin/styles/<?=$type_page;?>/<?=1?>/<?=1?>"><div id="add_producer">
		</div></a>
	...
	<div style="position:relative;width:365px;height:165px;display:inline-block;margin: 15px 0px 0px 5px;">
		<a href="/admin/styles/<?=$type_page;?>/<?=$value['id']?>">
		<li>
		...
		<img style="" height="124px" src="<?=$value['image']?>"></p>
		<?
		}
		else{
		?>
...
if (confirm('Удалить информацию о производителе '+name+'?'+'')) {
   $.ajax({
          type: 'POST',
		  dataType:'json',
          url: '/functions_ajax/delete_style/',
