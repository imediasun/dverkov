<script type="text/javascript" src="/js/jquery.damnuploader.js"></script>
	...
	<div style="" class="row row_style">
		<div class="span2">
			...
			<img height="200px" src="<?=$color[0]['img']?>">
			</p>
			<?}?>
		</div>
		<div style="border-left:1px solid #000;padding:10px;" class="span4">
			...
			<input name="name" style="height:30px;width:80%" type="text" value="<?=$color[0]['name']?>">
			<input name="id" type="hidden" value="<?=$color[0]['id']?>">
			<input name="type" type="hidden" value="<?=$type_page?>">
			<input name="proc" type="hidden" value="colors">
			<br>
			<h3 class="lab_">Типы дверей к которым относится данный цвет</h3>
			<div id="bar_block">
			<?
