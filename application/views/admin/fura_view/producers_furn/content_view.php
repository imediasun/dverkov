prod_furn
	<div class="span10a">
	<div id="progress_bar">
		<div class="icon_text_div"><h3 class="icon_text">Добавить производителя</h3></div>
		<a href="/admin/producer_edit/<?=$type_page;?>"><div id="add_producer">
		</div></a>
		<div class="icon_text_div"><h3 class="icon_text">Редактировать производителя</h3></div>
		<div id="edit_producer" class=""> 
		</div>
	...
	<div style="position:relative;width:365px;height:165px;display:inline-block;margin: 15px 0px 0px 5px;">
		<a href="/admin/furnitura_edit/<?=$type_page;?>/<?=$value['id']?>">
		<li>
		...
		<img style="" height="74px" src="<?=$value['logo']?>"></p>
		<?
		}
		else{
		?>
...
if (confirm('Удалить информацию о производителе '+name+'?'+'')) {
   $.ajax({
          type: 'POST',
		  dataType:'json',
          url: '/functions_ajax/delete_producer/',
		  data:{id:id},
          success: function(data) {
			alert('Информация о производителе удалена из базы данных')
			location.reload();
          },
