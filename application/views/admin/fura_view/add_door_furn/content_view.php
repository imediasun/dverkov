<div class="span10a">
	...
	<div id="progress_bar">
		...
		<div class="icon_text_div"><span class="logo_add_btn"><h3 class="icon_text"> Добавить фотографии фурнитуры</h3></span></div>
	...
	<div style="" class="row row_style">
		...
		<div class="door_view span4">
			...
			?>
			<img  height="420" src="<?=$meniatures[0]['path']?>">
			<?
			}
			else{
			?>
			<img src="<?=$meniatures[0]['path']?>">
			<?
			}
			?>
			</p>
			...
			<div style="border-left:1px solid #000;padding:10px;" class="span4">
				...
				<h3 class="lab_">Выберите модель фурнитуры</h3>
				<select id="door_model" name="door_model">
				<?
				...
				<h3 class="lab_">Название фурнитуры</h3>
				...
				<h3 class="lab_">Описание фурнитуры</h3>
