...
<div id="progress_bar">
	...
	<div class="prostir">
	<br>
	<h3 style="padding-left:10px;" class="icon_text"><?=$query_color_text?></h3>
	</div>
		...
		<div style="" class="row row_style">
			...
			<div style="border-left:1px solid #000;padding:10px;" class="span4">
				<div class="prostir"></div>
				<h3 class="lab_">Название цвета</h3>
...
alert(inf)
 ...
 $.ajax({
          type: 'POST',
		  dataType:'json',
          url: '/functions_ajax/save_color/',
		  data:{name_prod:name_prod,type_ar:type_ar,ses:ses},
          success: function(data){
			alert('Информация о цвете добавлена в базу данных')
			window.location.href = 'http://dverkov.com.ua/admin/colors/'+<?echo $type_index;?>+'';
          },
